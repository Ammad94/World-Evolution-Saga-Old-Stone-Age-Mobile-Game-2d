...
namespace PrehistoricSurvival.AI
{
    ...
    public class HerdMigrationSystem : MonoBehaviour
    {
        ...
        public List<AnimalAI> HerdAround(Vector3 center) { var result = new List<AnimalAI>(); foreach (var animal in FindObjectsOfType<AnimalAI>()) if (Vector3.Distance(center, animal.transform.position) <= herdRadius) result.Add(animal); return result; }
    }
}
